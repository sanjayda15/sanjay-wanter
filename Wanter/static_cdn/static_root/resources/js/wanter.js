      ...
      success: function(data){
        ...
        if (data.products.length > 0){
            ...
            $.each(data.products, function(index, value){
              ...
              cartBody.prepend("<tr><th scope=\"row\">" + i + "</th><td class=\"w-25\"><img class=\"mg-fluid imh img-thumbnail\" src='" + value.image + "'></td><td><a href='" + value.url + "'>" + value.name + "</a>" + newCartItemRemove.html() + "</td><td>" + value.price + "</td></tr>")
                i --
            })

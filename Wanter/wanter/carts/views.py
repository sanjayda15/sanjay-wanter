...
# def cart_create(user=None): ## another way to create a session
...
def cart_home(request):
    ...
    # print(dir(request.session)) # shows all the method it can execute
    # request.session.set_expiry(300) # 5 minutes
    # key = request.session.session_key
    # print(key)# show the key in perticular sessions
